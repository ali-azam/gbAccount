...
interface ReceivePaymentReportByOfficeProps {
  onView?: (filters: {
    office: string;
    dateFrom: string;
    dateTo: string;
...
export default function ReceivePaymentReportByOffice({
  onView,
}: ReceivePaymentReportByOfficeProps) {
  ...
  const handleView = () => {
    ...
    console.log("Receive Payment Report By Office:", data);
