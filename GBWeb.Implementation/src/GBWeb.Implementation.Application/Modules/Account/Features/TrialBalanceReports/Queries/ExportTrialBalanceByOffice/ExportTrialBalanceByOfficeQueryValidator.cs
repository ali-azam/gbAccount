...
public sealed class ExportTrialBalanceByOfficeQueryValidator
    : AbstractValidator<ExportTrialBalanceByOfficeQuery>
{
    public ExportTrialBalanceByOfficeQueryValidator()
    {
        RuleFor(x => x.DateTo)
            .NotEmpty()
