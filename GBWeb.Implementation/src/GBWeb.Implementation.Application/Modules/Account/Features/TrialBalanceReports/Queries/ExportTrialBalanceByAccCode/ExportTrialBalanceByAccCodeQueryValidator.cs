...
public sealed class ExportTrialBalanceByAccCodeQueryValidator
    : AbstractValidator<ExportTrialBalanceByAccCodeQuery>
{
    public ExportTrialBalanceByAccCodeQueryValidator()
    {
        RuleFor(x => x.DateTo)
            .NotEmpty()
