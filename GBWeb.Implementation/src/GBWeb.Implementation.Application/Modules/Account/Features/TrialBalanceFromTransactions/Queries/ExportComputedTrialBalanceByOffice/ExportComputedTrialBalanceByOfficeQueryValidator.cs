...
public sealed class ExportComputedTrialBalanceByOfficeQueryValidator
    : AbstractValidator<ExportComputedTrialBalanceByOfficeQuery>
{
    public ExportComputedTrialBalanceByOfficeQueryValidator()
    {
