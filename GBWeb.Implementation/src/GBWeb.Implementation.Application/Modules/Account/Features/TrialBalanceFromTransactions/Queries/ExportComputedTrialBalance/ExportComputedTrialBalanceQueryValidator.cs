...
public sealed class ExportComputedTrialBalanceQueryValidator
    : AbstractValidator<ExportComputedTrialBalanceQuery>
{
    public ExportComputedTrialBalanceQueryValidator()
    {
